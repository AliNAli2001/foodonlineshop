  ...
  return (
    <AdminLayout title={t('admin.pages.companies.edit.title')}>
      <div className="mx-auto max-w-3xl space-y-6">
        <section className="rounded-2xl border border-white/10 bg-white/[0.04] p-5"><h1 className="text-2xl font-bold text-white">Edit Company</h1></section>
        <form onSubmit={submit} className="space-y-4 rounded-2xl border border-white/10 bg-white/[0.04] p-5">
          ...
          {currentLogo && <img src={currentLogo} alt={company.name_en} className="h-36 rounded-xl object-cover" />}
