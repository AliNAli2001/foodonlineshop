        ...
        <div class="card shadow-sm border-0" style="border-radius: 12px; overflow: hidden;">
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        <div><strong>المبلغ الكلي:</strong> {{ $adjustment->quantity ?? '—' }}</div>
                    </div>
                    <div class="col-md-3">
                        <div><strong>النوع:</strong> <span
                                class="badge {{ $adjustment->adjustment_type === 'gain' ? 'bg-success' : 'bg-danger' }}">{{ $types[$adjustment->adjustment_type] ?? $adjustment->adjustment_type }}</span>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div><strong>السبب:</strong> {{ $adjustment->reason }} {{-- إضافة سجل للبضاعة المخربة في حال كانت موجودة --}}
