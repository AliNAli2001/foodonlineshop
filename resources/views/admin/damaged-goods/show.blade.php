        ...
        <div class="card shadow-sm border-0" style="border-radius: 12px; overflow: hidden;">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        <div><strong>التكلفة الكلية:</strong> {{ $damagedGoods->quantity * $damagedGoods->inventoryBatch->cost_price }}</div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            @if ($damagedGoods->inventoryBatch)
                                <a href="{{ route('admin.inventory.show', $damagedGoods->inventoryBatch) }}"
                                    class="link-primary">
                    ...
                    {{-- سجل التسوية المالية المرتبط --}}
                    <div class="col-md-6">
                        <div class="d-flex align-items-center gap-2">
                            <strong>سجل التسوية (الخسارة):</strong>
                            @if ($damagedGoods->adjustment)
                                <a href="{{ route('admin.adjustments.show', $damagedGoods->adjustment->id) }}"
                                    class="link-primary">
                                    سجل التسوية
                                </a>
                                <span class="text-muted small">(المعرف: {{ $damagedGoods->adjustment->id }})</span>
                            @else
                                <span class="text-muted">غير متوفر</span>
                            @endif
                        </div>
